module.exports = {
  default: {
    ...
    , appId         : null   //  FB
    , appSecret     : null
    //  for Twi etc `consumerKey` > `appId` renamed
    // , consumerKey   : null   //  Twi
    // , consumerSecret: null
  ...
  facebook: {
    ...
    , appId        : '260143207435587'
    , appSecret    : '2c12f9804dc18d8864522bbabcf31715'
    , appIco       : '/ico/social.me/48x48/facebook.png'
    , callbackURL  : 'https://auth.2128506.su/facebook/callback'

    , authPath     : '/facebook'
    , callbackPath : '/facebook/callback'
    , accountPath  : '/facebook/account'
    , loginPath    : '/facebook/login'
    , authenticate : { successRedirect: '/', failureRedirect: '/facebook/login' }
  }
  ,
  twitter: {
    name            : 'twitter'
  ...
  vkontakte: { 
    name          : 'vkontakte'
    , strategy    : 'passport-vkontakte'
    , appId       : '2149418'
    , appSecret   : 'CU5EOAYH7f2T3fiUDVum'
	  , callbackURL : 'https://auth.2128506.su/vkontakte/callback'
	  , authPath    : '/vkontakte'
	  , callbackPath: '/vkontakte/callback'
		, appIco      : '/ico/social.rus/48x48/vkontakte.png'
  }
  // , github: {
